...
Legacy `03_storyboard_v{N}.md` files can be read from `archives/` as migration inputs. They should not remain as active files under `deliverables/30_shotlist/`. The next saved planning version should use `03_shotlist_breakdown_v{N}.md`.
