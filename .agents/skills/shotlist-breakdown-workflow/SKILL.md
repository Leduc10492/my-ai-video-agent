...
If an existing `deliverables/30_shotlist/03_storyboard_v{N}.md` is the latest planning artifact, treat it as legacy input only. The next saved production planning artifact must be `deliverables/30_shotlist/03_shotlist_breakdown_v{N}.md`.
