...
- Script: `deliverables/1_story/01_script_v{N}.md`
- Audit: `deliverables/1_story/01_audit_report_v{N}.md`
- Asset guide: `deliverables/2_assets/02_asset_guide_v{N}.md`
- Style guide: `deliverables/2_assets/02_style_guide_v{N}.md`
- Shotlist breakdown: `deliverables/3_shotlist/<scene-label>_v{N}/03_shotlist_breakdown_<scene-label>_v{N}.md`
- Shotlist HTML: `deliverables/3_shotlist/<scene-label>_v{N}/Shotlist_<scene-label>_ZH_v{N}.html`
- Scene package manifest: `deliverables/3_shotlist/<scene-label>_v{N}/manifest.md`
- Shotlist previews: `deliverables/3_shotlist/<scene-label>_v{N}/previews/manifest.md`
- Generated video tests: `deliverables/3_shotlist/<scene-label>_v{N}/generated/<run_id>/README.md`
