...
```
风格：超写实自然主义电影摄影——禁3D渲染，禁游戏引擎，禁游戏CG过场质感。灯光：严格仅使用场景内实际存在的光源（practicals）。禁止一切画面外补光——禁正面补光、禁反光板、禁柔光箱、禁LED灯带、禁无来源霓虹。摄影机从人物阴影侧取景，现场光形成自然轮廓与眼神光。轻微空气透视增加纵深，禁止可见光束。色彩：60:30:10——主色/辅色/点缀色。镜头：物理电影镜头，180°快门运动模糊。皮肤：毛孔、汗毛、非对称细节与毛细血管潮红匹配现场光。表演：反应前微停顿、精准视线、可见呼吸和胸腔起伏。物理：重力、惯性、重量和接触阴影真实。禁漂浮道具。连续性：角色、道具、环境跨内部镜头保持一致。禁身份漂移。音频：仅场景内环境声与明确对白。禁音乐。禁字幕。
```
...
### Night interior — natural light only
```
